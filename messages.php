...
<legend>Type here to leave a messages</legend>
...
<input data-transaction="slide" type="submit" value="Post Messages">
</form><br>
_END;
        ...
        $row['recip'] == $user)
        {
            ...
            if ($row['pm'] == 0)
                ...
                echo "whispered: <span class='whisper'>&quot;" .
                    $row['message']. "&quot;</span>span>";
            if ($row['recip'] == $user)
                echo "[<a href='messages.php?view=$view" . "&$erase=" . $row[id]. "' . 
                       >erase</a> ]";
